...
define( 'WPCACHEHOME', '/home/w5000074/public_html/wp-content/plugins/wp-super-cache/' );
$sDestDir = '/home/w5000074/public_html';
if ( substr($sDestDir, 0, 1) == "\\" ) {
      $sDestDir = "\\".$sDestDir ;
}

/** El nombre de tu base de datos de WordPress */
define('DB_NAME', 'w5000074_wordpre');

/** Tu nombre de usuario de MySQL */
define('DB_USER', 'w5000074_wordpre');

/** Tu contraseña de MySQL */
define('DB_PASSWORD', 'hnjmmlasbm6Bjyt');
