...
<!-- Google AdSense -->
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5630949960710921"
			...
			<div class="lg:flex lg:justify-between lg:items-center border-b py-2">
				...
				wp_nav_menu(
					array(
						...
						'li_class_0'      => 'lg:pb-2 lg:mx-4 lg:relative group hover:text-blue-700',
